...
test('baseline tables expose the retained application columns', function (string $table, array $columns): void {
    ...
    'Transactions' => ['transactions', [
        ...
        'direction', 'income_source', 'transfer_purpose',
        'description', 'instrument_label', 'instrument_last_four',
        'confirmed_at', 'provisional_fields', 'voided_at', 'original_spending_id',
