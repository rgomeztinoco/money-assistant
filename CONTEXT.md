...
A confirmed Transaction with no owner Category or deterministic Learned Rule match. It remains included in total spending, appears in the system Uncategorized reporting bucket, and waits in the Review Queue; Uncategorized is not a customizable Category or a Learned Rule target.
_Avoid_: Uncategorized Category

**Category Assignment Provenance**:
The visible source of a Transaction's current Category: an owner action, a linked Refund's purchase, or a specific Learned Rule revision.
